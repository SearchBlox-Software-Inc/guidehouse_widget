  ...
  render(){
    ...
    return (
      <>
        ...
        {/* {
          (this.state.PDFOverlayShown)?<FileViewerComponent result={this.state.result} PDFOverlayShown={this.state.PDFOverlayShown} hidePDFOverlay={this.hidePDFOverlay}/>:""
        } */}
        {
          PDFOverlayShown ?
 ...
 return (
  <div className={`single-result-container ${!props.highlight ? 'noHighlight' : ''}`}>
     <div className={contentType === "html"?"searchResult":""}>
      {result && <h3 className="facet-col-name">{result.limitfilter}</h3>}
       {
